			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='success'>";
				    	...
				    	echo "<td><a href='actualizar.php?id=$arreglo[0]'><center><img src='images/admin/editar.png' class='img-rounded'></td>";
						echo "<td><a href='admin.php?id=$arreglo[0]&idborrar=2'><center><img src='images/admin/eliminar.png' class='img-rounded'/></a></td>";
